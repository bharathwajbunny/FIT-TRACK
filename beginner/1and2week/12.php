...
<head>
    ...
    <title>Upper Body Exercises - FitTrack</title>
...
<body>
    <header>
        <h1>Upper Body Exercises - FitTrack</h1>
        <nav>
            <ul>
    ...
    <nav class="workout-nav">
        <ul>
            ...
            <li><a href="#upperbody">Upper Body</a></li>
        </ul>
    </nav>
    ...
    <main>
        <section id="upperbody">
            ...
            <p>Strengthen your upper body with these exercises:</p>

            <!-- Exercise 1: Pull-ups or Chin-ups -->
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/beginner/1and2week/1.jpg" alt="Pull-ups or Chin-ups">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/beginner/1and2week/1.1.mp4" type="video/mp4">
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/beginner/1and2week/2.jpg" alt="Dumbbell Curl">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/beginner/1and2week/2.2.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/beginner/1and2week/3.jpg" alt="Push-Ups">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/beginner/1and2week/3.3.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <!-- Timer for Push-ups -->
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/beginner/1and2week/4.jpg" alt="Squats (Without Dumbbell or Barbell)">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/beginner/1and2week/4.4.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <!-- Timer for Squats -->
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/beginner/1and2week/5.jpg" alt="Triceps Pushdowns">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/beginner/1and2week/5.5.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/beginner/1and2week/6.jpg" alt="Reverse Fly (Rear Delt Fly)">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/beginner/1and2week/6.6.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
    ...
    <script>
        // Timer functions for Upper Body Exercises
        let alarmSound;
        ...
        // Assign each exercise's timer start action
