...
<head>
    ...
    <title>Day 5 Workout - FitTrack</title>
    <link rel="stylesheet" href="/j/public/workouts/work.css">
</head>
<body>
    <header>
        <h1>Day 5 Workout - FitTrack</h1>
        <nav>
            <ul>
    ...
    <nav class="workout-nav">
        <ul>
            ...
            <li><a href="#day5">Biceps & Triceps </a></li>
        </ul>
    </nav>

    <main>
        <section id="day5">
            <h2>Day 5 Arms (Biceps & Triceps) Exercises</h2>
            <p>Strengthen your arms and triceps with these exercises:</p>

            <!-- Exercise 1: Barbell Curl -->
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day5/1.jpg" alt="Barbell Curl">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day5/1.1.mp4" type="video/mp4">
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day5/2.jpg" alt="Dumbbell Curl">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day5/2.2.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day5/3.jpg" alt="Hammer Curl">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day5/3.3.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day5/4.jpg" alt="Overhead Triceps Extension">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day5/4.4.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day5/5.jpg" alt="Triceps Pushdowns">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day5/5.5.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day5/6.jpg" alt="Diamond Push-ups">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day5/6.6.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
