...
<head>
    ...
    <title>Leg Exercises - Day 4 - FitTrack</title>
...
<body>
    <header>
        <h1>Leg Exercises - Day 4 - FitTrack</h1>
        <nav>
            <ul>
    ...
    <main>
        <section id="legs">
            <h2>Leg Exercises - Day 4</h2>
            <p>Strengthen your legs with these exercises for Day 4:</p>

            <!-- Exercise 1: Barbell Squats -->
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day4/1.jpg" alt="Barbell Squats">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day4/1.1.mp4" type="video/mp4">
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day4/2.jpg" alt="Leg Press">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day4/2.2.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <!-- Timer for Leg Press -->
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day4/3.jpg" alt="Lunges (Dumbbell or Barbell)">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day4/3.3.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <!-- Timer for Lunges -->
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day4/4.jpg" alt="Leg Curls (Hamstring Curls)">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day4/4.4.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <!-- Timer for Leg Curls -->
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day4/5.jpg" alt="Leg Extensions">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day4/5.5.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day4/6.jpg" alt="Calf Raises">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day4/6.6.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
    ...
    <script>
        // Timer functions for Day 4 Leg Exercises
        let alarmSound;
