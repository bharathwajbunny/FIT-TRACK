...
<head>
    ...
    <title>Day 1 Chest Exercises - FitTrack</title>
    <link rel="stylesheet" href="/j/public/workouts/work.css">
</head>
<body>
    <header>
        <h1>Day 1 Chest Exercises - FitTrack</h1>
        <nav>
            <ul>
    ...
    <main>
        <section id="chest">
            <h2>Day 1 Chest Exercises</h2>
            <p>Build your chest with these exercises:</p>

            <!-- Barbell Bench Press -->
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day1/1.jpg" alt="Barbell Bench Press">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day1/1.1.mp4" type="video/mp4">
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day1/2.jpg" alt="Dumbbell Bench Press">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day1/2.2.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day1/3.jpg" alt="Incline Dumbbell Press">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day1/3.3.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day1/4.jpg" alt="Chest Fly (Dumbbell or Cable)">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day1/4.4.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <!-- Timer for Chest Fly -->
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day1/5.jpg" alt="Push-Ups">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day1/5.5.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <!-- Timer for Push-Ups -->
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day1/6.jpg" alt="Cable Chest Press">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day1/6.6.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
    ...
    <script>
        // Timer functions (same as the one from previous code)
        let alarmSound;
