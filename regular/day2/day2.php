...
<head>
    ...
    <title>Back Exercises - Day 2 - FitTrack</title>
...
<body>
    <header>
        <h1>Back Exercises - Day 2 - FitTrack</h1>
        <nav>
            <ul>
    ...
    <nav class="workout-nav">
        <ul>
            ...
            <li><a href="#upper-back">Back</a></li>
        ...
        <section id="upper-back">
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day2/1.jpg" alt="Pull-ups">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day2/1.1.mp4" type="video/mp4">
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day2/2.jpg" alt="Barbell Rows">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day2/2.2.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day2/3.jpg" alt="T-Bar Rows">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day2/3.3.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day2/4.jpg" alt="Dumbbell Rows">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day2/4.4.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day2/5.jpg" alt="Cable Rows">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day2/5.5.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/regular/day2/10.jpg" alt="Deadlifts">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/regular/day2/6.6.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <!-- Timer for Deadlifts -->
