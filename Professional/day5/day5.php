...
<head>
    ...
    <title>Day 5 Workout - Chest & Back - FitTrack</title>
    <link rel="stylesheet" href="/j/public/workouts/daybyday/day.css">
</head>
<body>
    <header>
        <h1>Day 5 Workout - Chest & Back - FitTrack</h1>
        <nav>
            <ul>
    ...
    <nav class="workout-nav">
        <ul>
            ...
            <li><a href="#evening-back">Evening - Back</a></li>
        </ul>
    </nav>
    ...
    <main>
        <section id="morning-chest">
            ...
            <div class="exercise-container">
                <div class="exercise-details">
                    ...
                    <img src="/j/public/workouts/professional/day5/1.jpg" alt="Barbell Bench Press" width="320" height="240">
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/professional/day5/1.1.mp4" type="video/mp4">
            ...
            <div class="exercise-container">
                <div class="exercise-details">
                    ...
                    <img src="/j/public/workouts/professional/day5/2.jpg" alt="Incline Dumbbell Press" width="320" height="240">
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/professional/day5/2.2.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <div class="timer-container">
            ...
            <div class="exercise-container">
                <div class="exercise-details">
                    ...
                    <img src="/j/public/workouts/professional/day5/3.jpg" alt="Chest Fly" width="320" height="240">
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/professional/day5/3.3.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <div class="timer-container">
        ...
        <section id="evening-back">
            <h2>Evening - Back Exercises</h2>
            <p>Focus on strengthening your back with these exercises:</p>

            <!-- Exercise 1: Pull-Ups -->
            <div class="exercise-container">
                <div class="exercise-details">
                    <strong>Pull-Ups (Weighted if possible)</strong>
                    <ul>
                        <li>Sets: 4</li>
                        <li>Reps: 6-8</li>
                    </ul>
                    <img src="/j/public/workouts/professional/day5/4.jpg" alt="Pull-Ups" width="320" height="240">
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/professional/day5/4.4.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <div class="timer-container">
            ...
            <div class="exercise-container">
                <div class="exercise-details">
                    ...
                    <img src="/j/public/workouts/professional/day5/5.jpg" alt="Deadlifts" width="320" height="240">
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/professional/day5/5.5.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <div class="timer-container">
            ...
            <!-- Exercise 3: Good Mornings (Weighted) -->
            <div class="exercise-container">
                <div class="exercise-details">
                    <strong>Good Mornings (Weighted)</strong>
                    <ul>
                        <li>Sets: 3</li>
                        <li>Reps: 8-10</li>
                    </ul>
                    <img src="/j/public/workouts/professional/day5/6.jpg" alt="Good Mornings" width="320" height="240">
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/professional/day5/6.6.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <div class="timer-container">
