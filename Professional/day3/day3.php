...
<head>
    ...
    <title>Day 3 Workout - Shoulders & Abs - FitTrack</title>
    <link rel="stylesheet" href="/j/public/workouts/daybyday/day.css">
</head>
<body>
    <header>
        <h1>Day 3 Workout - Shoulders & Abs - FitTrack</h1>
        <nav>
            <ul>
        ...
        <section id="morning-shoulders">
            ...
            <div class="exercise-container">
                <div class="exercise-details">
                    ...
                    <img src="/j/public/workouts/professional/day3/1.jpg" alt="Overhead Barbell Press" width="320" height="240">
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/professional/day3/1.1.mp4" type="video/mp4">
            ...
            <div class="exercise-container">
                <div class="exercise-details">
                    ...
                    <img src="/j/public/workouts/professional/day3/2.jpg" alt="Dumbbell Lateral Raises" width="320" height="240">
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/professional/day3/2.2.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <div class="timer-container">
            ...
            <div class="exercise-container">
                <div class="exercise-details">
                    ...
                    <img src="/j/public/workouts/professional/day3/3.jpg" alt="Arnold Press" width="320" height="240">
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/professional/day3/3.3.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <div class="timer-container">
        ...
        <section id="evening-abs">
            ...
            <div class="exercise-container">
                <div class="exercise-details">
                    ...
                    <img src="/j/public/workouts/professional/day3/4.jpg" alt="Planks" width="320" height="240">
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/professional/day3/4.4.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <div class="timer-container">
            ...
            <div class="exercise-container">
                <div class="exercise-details">
                    ...
                    <img src="/j/public/workouts/professional/day3/5.jpg" alt="Cable Woodchoppers" width="320" height="240">
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/professional/day3/5.5.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <div class="timer-container">
            ...
            <div class="exercise-container">
                <div class="exercise-details">
                    ...
                    <img src="/j/public/workouts/professional/day3/6.jpg" alt="Leg Raises" width="320" height="240">
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/professional/day3/6.6.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
                <div class="timer-container">
