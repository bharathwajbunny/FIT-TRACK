...
<head>
    ...
    <title>Core Exercises - FitTrack</title>
    <link rel="stylesheet" href="work.css">
</head>
<body>
    <header>
        <h1>Core Exercises - FitTrack</h1>
        <nav>
            <ul>
    ...
    <main>
        <section id="core">
            ...
            <p>Strengthen your core with these exercises:</p>

            <!-- Planks -->
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/core/1.jpg" alt="Planks">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/core/1.1.mp4" type="video/mp4">
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/core/2.jpg" alt="Russian Twists">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/core/2.2.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/core/3.jpg" alt="Leg Raises">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/core/3.3.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/core/4.jpg" alt="Bicycle Crunches">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/core/4.4.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/core/5.jpg" alt="Cable Woodchoppers">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/core/5.5.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            ...
            <div class="exercise-container">
                <div class="exercise-image">
                    <img src="/j/public/workouts/core/6.jpg" alt="Mountain Climbers">
                </div>
                <div class="exercise-details">
                    ...
                    <video width="320" height="240" controls>
                        <source src="/j/public/workouts/core/6.6.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
